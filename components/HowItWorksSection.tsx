  ...
  const steps = [
    {
      ...
      description: 'Sign up and build your profile by listing skills you can teach and skills you want to learn. Add your availability and preferences.',
    ...
    },
    {
      ...
      description: 'Browse through our community of skilled individuals. Search by specific skills, location, or availability to find your perfect learning partner.',
      icon: 'ri-search-2-line',
      image: 'https://readdy.ai/api/search-image?query=Person%20browsing%20and%20searching%20through%20profiles%20on%20computer%20screen%2C%20skill%20matching%20interface%20with%20user%20cards%20and%20search%20filters%2C%20modern%20web%20application%20design%2C%20collaborative%20learning%20platform&width=600&height=400&seq=skill-discovery&orientation=landscape'
    },
    {
      step: '03',
      title: 'Exchange Skills',
      description: 'Send swap requests and start learning! Meet virtually or in person, share knowledge, and grow together in a supportive environment.',
    ...
    },
    {
      step: '04',
      title: 'Rate & Grow',
      description: 'After each swap, rate your experience and provide feedback. Build your reputation and help others make informed connections.',
      icon: 'ri-star-line',
